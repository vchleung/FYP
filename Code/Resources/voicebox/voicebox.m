...
if isempty(PP)
    ...
    PP.dir_temp='C:\hang\Imperial\4th Year\FYP\voicebox\TEMP';                      % directory for storing temporary files
    PP.dir_data='C:\hang\Imperial\4th Year\FYP\voicebox\data\speech';           % default directory to preappend to speech data file names
    PP.shorten='C:\hang\Imperial\4th Year\FYP\voicebox\shorten.exe';            % location of shorten executable
    PP.flac='C:\hang\Imperial\4th Year\FYP\voicebox\flac.exe';                  % location of flac executable
