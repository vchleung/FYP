...
%title
uicontrol(fig,'Style','Text','Units','characters','Position',[0 29 width 1.5],'FontSize',12,'String',['Task ' num2str(currQuestion) '/' num2str(length(questions)) ': ' questions{currQuestion} ' - Experiment 1/' int2str(nbexpe)],'Tag','experiment');
...
uicontrol(fig,'Style','Pushbutton','Units','characters','Position',[3.5 5.7 19 1.8],'FontSize',10,'String','Play reference','Callback','evaluation_callbacks(''play'',guidata(gcbo),0)','Tag','play0','BackgroundColor',[0.7 1 0.7]);
uicontrol(fig,'Style','Pushbutton','Units','characters','Position',[3.5 (5.7-1.8-1) 19 1.8],'FontSize',10,'String','Play mixture','Callback','evaluation_callbacks(''play'',guidata(gcbo),-1)','Tag','play00','BackgroundColor',[1 0.7 0.7])
